...
class Dropbox < BasePageObject
  ...
  textfield 'login_google', xpath: "//android.widget.EditText[@index='0']", delay: 3
  ...
  def self.add_account(account)
    ...
    pass_google_textfield_fill account[:pass_st]   if
    hardback delay: 3
    next_google_button_click                       if next_google_button_wait
    name_dropbox_textfield_fill account[:storage]  if name_dropbox_textfield_wait
